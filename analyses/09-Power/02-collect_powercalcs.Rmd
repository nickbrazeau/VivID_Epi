...
pfpower.files <- list.files("~/Documents/GitHub/VivID_Epi/analyses/09-Power/_rslurm_powercalc_pf/", pattern = ".RDS", full.names = T)
...
pfpower.files.ret <- lapply(pfpower.files$power.files, read_power_files, species = "Pf") %>% 
  dplyr::bind_rows()
pfpoweriters.ret <- readRDS("~/Documents/GitHub/VivID_Epi/analyses/09-Power/_rslurm_powercalc_pf/params.RDS") 
...
pvpower.files <- list.files("~/Documents/GitHub/VivID_Epi/analyses/09-Power/_rslurm_powercalc_pv/", pattern = ".RDS", full.names = T)
...
pvpower.files.ret <- lapply(pvpower.files$power.files, read_power_files, species = "Pv") %>% 
  dplyr::bind_rows()
pvpoweriters.ret <- readRDS("~/Documents/GitHub/VivID_Epi/analyses/09-Power/_rslurm_powercalc_pv/params.RDS") 
