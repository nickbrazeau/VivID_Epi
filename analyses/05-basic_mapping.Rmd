...
gcdist <- ge %>% 
  ...
  sf::st_distance(x = ., which = "Great Circle", by_element = F)
...
caseprevmaps[[2]] + ggrepel::geom_label_repel(aes(x = longnum, y = latnum, label = plsmdn))
...
pfprevmap <-  prevmaprasterplots_lrg[[1]] +
  ggtitle(expression(bolditalic("P. falciparum")))1 +
  prettybasemap_nodrc + 
  theme(
    legend.position = "right",
    legend.text = element_text(face = "bold", angle = 0, vjust = 0.5, hjust = 0.5)
