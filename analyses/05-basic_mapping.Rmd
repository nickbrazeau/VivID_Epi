...
jpeg("~/Documents/GitHub/VivID_Epi/results/figures/pf-prevmap_nice.jpg", width = 11, height = 8, units = "in", res = 500)
plot(pfprevmap)
graphics.off()
...
jpeg("~/Documents/GitHub/VivID_Epi/results/figures/Africa_Inset_clsts.jpg", width = 11, height = 8, units = "in", res = 500)
cowplot::ggdraw() +
...
### Case Plot (Prettier - Dark Background)
...
jpeg("~/Documents/GitHub/VivID_Epi/results/figures/Africa_Inset_PvClstPrev_dark.jpg", width = 11, height = 8, units = "in", res = 500)
cowplot::ggdraw() +
