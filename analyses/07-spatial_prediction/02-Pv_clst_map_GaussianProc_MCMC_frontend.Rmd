...
mod.framework$summdiagret <- invisible( purrr::map(mod.framework$mcmc, get_diag_summ_results.Bayes.PrevMap) )
...
PrevMap::trace.plot(long.covar, param = "beta", component.beta = 4)
PrevMap::autocor.plot(long.covar, param = "beta", component.beta = 4)


PrevMap::trace.plot(long.covar, param = "beta", component.beta = 5)
PrevMap::autocor.plot(long.covar, param = "beta", component.beta = 5)
