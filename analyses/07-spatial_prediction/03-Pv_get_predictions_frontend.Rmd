...
precip.plot <- ggspatial::layer_spatial(data = covar.rstr.pred[["precip_mean_cont_scale_clst"]], 
                                        aes(fill = stat(band1))) +
  scale_fill_viridis_c("Precip", na.value = NA) +
  theme_void()

crop.plot <- ggspatial::layer_spatial(data = covar.rstr.pred[["cropprop_cont_scale_clst"]], 
                                        aes(fill = stat(band1))) +
  scale_fill_viridis_c("Crop Prop.", na.value = NA) +
  theme_void()

hlthdist.plot <- ggspatial::layer_spatial(data = covar.rstr.pred[["hlthdist_cont_scale_clst"]], 
                                        aes(fill = stat(band1))) +
