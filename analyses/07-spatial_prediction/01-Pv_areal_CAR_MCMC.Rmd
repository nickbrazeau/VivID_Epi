...
nightlights <- readRDS("~/Documents/GitHub/VivID_Epi/data/derived_data/vividepi_nightlights_surface.rds")
...
# combine
pvprov.weighted <- dplyr::left_join(pvprov.weighted, pvcovar, by = "adm1name")
