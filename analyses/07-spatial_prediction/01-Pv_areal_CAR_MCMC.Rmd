...
wrap_chain_plotter(diag.dir = mytempdir, chains = chains)
...
mod.framework.long$n.sample <- 1e8
...
readr::write_csv(x = mod.framework.long, path = "~/Documents/GitHub/VivID_Epi/results/tables/Prov_Level_HierBayesSP_models.csv")
