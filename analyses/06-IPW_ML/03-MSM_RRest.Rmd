...
svglite::svglite("~/Documents/GitHub/VivID_Epi/results/figures/dag.svg",
     width = 11, height = 8)
plot(dagplot)
graphics.off()
...
jpeg(filename = "~/Documents/GitHub/VivID_Epi/results/figures/IPTWMSM_final_figure_long.jpg", width = 14, height = 8, units = "in", res = 600)
plot(finalMSMplot)
graphics.off()
...
### Appendix: Digging into _Pv_-Farming
```{r, results='asis'}

dtsrvyr.app <- makecd2013survey(survey = dt)

dtsrvyr.app %>% 
  dplyr::group_by(farmer_fctb, pv18s_fctb) %>% 
