...
```{r}
covar.files <- list.files("analyses/03-covar_assoc/_rslurm_covar_corr/", pattern = ".RDS", full.names = T)
...
paramsdf <- readRDS("analyses/03-covar_assoc/_rslurm_covar_corr/params.RDS") %>% 
  dplyr::select(-c(data))
