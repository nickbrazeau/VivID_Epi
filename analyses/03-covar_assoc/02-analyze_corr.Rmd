...
```{r}
covar.files <- list.files("~/Documents/MountPoints/mountedMeshnick/Projects/VivID_Epi/analyses/03-covar_assoc/_rslurm_covar_corr/", pattern = ".RDS", full.names = T)
...
paramsdf <- readRDS("~/Documents/MountPoints/mountedMeshnick/Projects/VivID_Epi/analyses/03-covar_assoc/_rslurm_covar_corr/params.RDS") %>% 
  dplyr::select(-c(data))
