...
# Section 3: Exploratory Data Analysis of Risk Factors
...
paramsdf <- readRDS("~/Documents/MountPoints/mountedMeshnick/Projects/VivID_Epi/analyses/05-covar_assoc/_rslurm_covar_corr/params.RDS") %>% 
  dplyr::select(-c(data))
