---
title: "Univariate and Bivariate Summary Statistics for _P. vivax_ and _P. falciparum_ Malaria among Asymptomatic Adults in the DRC"
...
NB Given that everyone is weighted the same in the cluster, we do not need to use weights explicitly. However, this will results in the slightly different numerator (e.g. $n_numerator$) but the denominators adjust for this. Caution is warranted when reporting weighted versus unweighted Ns at the cluster-level for this reason. 
