...
# Then manually curate the above covar_names_labels.csv in the internal_covar_map.xlsx file
# hate to use excel and manually curate covars...but necessary evil here 
