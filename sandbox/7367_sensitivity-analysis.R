...
# empirical evidence to believe that this really a 42
...
vars <- vars[!vars %in% c("hv005_cont", "hiv05_cont", "hhid_fctm", "hvdate_cont")]
...
covars <- covars[!covars %in% c("hv005_cont", "hiv05_cont", "hhid_fctm", "hvdate_cont", "pv18s_fctb", "pv18sct_cont", "pv18s", "pv18s_sens")]
model_parameters <- data.frame(outcome = rep("pv18s_sens", length(covars)), 
...
save(pftbl1, pvtbl1, model_parameters, file = paste0(out, "/", "03-Uni_Bivar_analyses_SENS.rda"))
