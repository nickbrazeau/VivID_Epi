...
vivid_theme <- theme(plot.title = element_text(family = "Arial", face = "bold", hjust = 0.5, size = 14), 
                     axis.title = element_text(family = "Arial", face = "bold", hjust = 0.5, size = 12), 
                     axis.text = element_text(family = "Arial", hjust = 0.5, size = 11), 
                     legend.position = "bottom",
                     legend.title = element_text(family = "Arial", face = "bold", vjust = 0.85, size = 12),
                     legend.text = element_text(family = "Arial", hjust = 0.5, vjust = 0.5, angle = 90, size = 10),
