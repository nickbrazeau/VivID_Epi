...
load("~/Documents/GitHub/VivID_Epi/reports/report_obj/03-Uni_Bivar_analyses.rda")
...
# Non-parametric, Bivariate Analysis for _P. falciparum_
For potential risk factors, these are the nx2 tables for categorical variables and mean/t-test for continuous.
```{r}

tableone::kableone(pftbl1) %>% 
...
## Estimates  {.tabset .tabset-fade .tabset-pill}
...
### Subset
```{r}
# make a table with the covar that you estimated when you bind 
# have a smaller subset for interpreting 
